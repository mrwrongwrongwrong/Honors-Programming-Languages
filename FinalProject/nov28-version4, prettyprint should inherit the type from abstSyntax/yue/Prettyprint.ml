...
type command = 
  | VarDecl of (var * command) (*var is equal to Declaration/Varable Declaration *)
...
and expression =
  ...
  | Location of (expression * expression) (*e.e in MiniOOSOS.pdf *) (*Location means Dot as e.e *)
  | Proc of (var * command)
  | Null of unit
  | Var of string
