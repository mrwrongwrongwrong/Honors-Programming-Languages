...
scoping_expression e var_lst = match e with 
    ...
    | Location (e1, e2) -> (scoping_expression e1 var_lst) || (scoping_expression e2 var_lst) (*e.e *) (*or you can call it dot *)
    | Proc (v, c) -> (scoping_command c (SS.add v var_lst)) (*proc y:C *)
    | _ -> false (*| Null -> false (*Null *)) *)
and
scoping_bool_expression bo var_lst = match bo with
    | Booll bo -> false (*true and false as b.E = false *)
    | Equal (e1, e2) -> (scoping_expression e1 var_lst) || (scoping_expression e2 var_lst) (*b.E=e1.E∨e2.E *)
    | Lt (e1, e2) -> (scoping_expression e1 var_lst) || (scoping_expression e2 var_lst)
